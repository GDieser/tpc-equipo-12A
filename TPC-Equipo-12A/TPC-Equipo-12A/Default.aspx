    ...
    <section class="division">
        <div class="container my-5 text-center">
            ...
            <div class="text-center">
                <img style="width: 250px" src='<%= ResolveUrl("~/Icons/logoIntro.png") %>' alt="Alternate Text" />
            </div>

            <h1 class="display-4 text-light">Bienvenido a <span class="text-primary">MisCursos.com</span></h1>
            <p class="lead text-secondary">Formación online de calidad, para llevar tu conocimiento al siguiente nivel.</p>
